...
public static class Program
{
    ...
    public static HttpWebResponse DigestAuthWithFile(string urlString, string username, string password, string filePath)
    {
        ...
        Console.WriteLine($"realm {realm} nonce: {nonce} qop: {qop}");
    ...
    static void Main(string[] args)
    {
        ...
        string filePath = "config_default.xml"; // Substitua pelo caminho do seu arquivo

        try
        {
            var response = DigestAuthWithFile(url, username, password, filePath);
            ...
            {
                Console.WriteLine("Erro: " + response.StatusDescription);
            }
        }
        catch (Exception ex)
        {
